...
if (empty($_SESSION['admin_id'])) {
  ...
  $tpp_menu_text = 'Set Tabbed Products Pro options';
    ...
    $menu_items_tpp = array(
            array('TPP_VERSION','1.5.0',1001,false),
    ...
    if($original_config->RecordCount())
    {
        ...
        $sql = "INSERT INTO ".TABLE_CONFIGURATION_GROUP." (configuration_group_title, configuration_group_description, sort_order, visible) VALUES ('".$tpp_menu_title."', '".$tpp_menu_text."', ".$sort.", '1')";
        $db->Execute($sql);
        ...
        if(!unlink(DIR_FS_ADMIN . DIR_WS_INCLUDES . 'auto_loaders/config.tpp.php'))
	{
       ...
       $messageStack->add('Tabbed Products Pro 1.5.0 erfolgreich installiert!','success');
